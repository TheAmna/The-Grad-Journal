...
HD_PWD='C:/Users/aa09863/Desktop/CA_LAB/CA_LAB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsm_top.tcl -notrace
