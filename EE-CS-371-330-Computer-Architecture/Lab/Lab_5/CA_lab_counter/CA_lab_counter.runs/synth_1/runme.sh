...
HD_PWD='C:/Users/aa09863/Desktop/CA_LAB/CA_LAB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm_top.tcl
