...
HD_PWD='C:/Users/aa09863/Downloads/lab9finall/lab9finall/lab9finall.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log InstructionMemory.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source InstructionMemory.tcl -notrace
